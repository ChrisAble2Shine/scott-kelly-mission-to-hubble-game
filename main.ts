...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Player, function (sprite, otherSprite) {
    ...
    game.showLongText("You have successfully navigated the Discovery to the Hubble", DialogLayout.Bottom)
    game.showLongText("Thank you for helping me", DialogLayout.Bottom)
    game.reset()
})
...
game.showLongText("A trip to the Hubble", DialogLayout.Bottom)
scene.setBackgroundImage(assets.image`kellyScreen`)
game.showLongText("I am astronaut Scott Kelly", DialogLayout.Bottom)
game.showLongText("And I need your help to navigate the Discovery", DialogLayout.Bottom)
game.showLongText("Use the arrow keys to move the Discovery", DialogLayout.Bottom)
startGame()
